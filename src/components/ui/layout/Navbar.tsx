    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <Link
            href="/"
            className="text-xl font-bold text-text-primary tracking-tight hover:text-accent-electric transition-colors"
          >
            STORELUXE
          </Link>
                  ...
                  {accountOpen && (
                    ...
                    >
                      <div className="px-3 py-2 border-b border-text-primary/10 mb-1">
                        ...
                        <p className="text-xs text-accent-electric">
                          {user.level}
                        </p>
                      </div>
                  ...
                  <>
                    ...
                    {user.role === "ADMIN" && (
                      <Link
                        href="/admin"
                        onClick={() => setMobileOpen(false)}
                        className="text-accent-electric py-2"
                      >
                        Admin
                      </Link>
                    )}
                    ...
                    <button
                      ...
                      className="text-text-secondary hover:text-text-primary py-2 text-left"
                    >
                      Carrello ({itemCount})
                    </button>
