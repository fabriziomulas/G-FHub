    ...
    <>
      ...
      <main className="pt-24 min-h-screen">
        <div className="max-w-7xl mx-auto px-6 py-12">
          <h1 className="text-4xl md:text-5xl font-bold text-text-primary mb-2">Nuovi Arrivi</h1>
          <p className="text-text-secondary mb-8">Le ultime novità appena arrivate</p>
